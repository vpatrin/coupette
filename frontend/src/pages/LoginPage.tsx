      ...
      <div className="relative flex flex-col items-center gap-6 w-full max-w-sm">
        ...
        <div className="flex flex-col items-center gap-3 w-full">
          <a
            ...
            className="flex items-center justify-center gap-2 w-[320px] max-w-full h-10 rounded-lg bg-white text-[#3c4043] text-sm font-medium border border-[#dadce0] hover:bg-[#f8f9fa] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-[320px] max-w-full h-10 rounded-lg bg-[#24292f] text-white text-sm font-medium hover:bg-[#2f363d] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors"
          >
