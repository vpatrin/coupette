            ...
            <div className="shrink-0 px-[var(--spacing-sidebar-x)] pt-5 pb-3">
              <div className="mb-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-muted-foreground/60 hover:text-muted-foreground hover:bg-surface-hover flex h-7 w-7 items-center justify-center rounded-lg transition-colors"
                >
