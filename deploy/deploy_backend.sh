...
(
    ...
    sops --decrypt --output-type dotenv secrets/monitor-scraper.env.enc > secrets/monitor-scraper.env
    sops --decrypt --output-type dotenv secrets/monitor-availability.env.enc > secrets/monitor-availability.env
)
