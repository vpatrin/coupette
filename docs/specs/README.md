...
Implementation design of shipped features — architecture, data flow, schemas. Not for planned features (use [ROADMAP.md](../ROADMAP.md)) or technical forks (use [decisions/](../decisions/)).
...
| [TELEGRAM_BOT](TELEGRAM_BOT.md) | Alert-only bot, stock events, store watches |
